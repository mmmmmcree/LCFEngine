#include "convert_from_color_to_gray.h"

void lcf::details::convert_from_color_to_gray(Image::ImageVariant &src_image_var, Image::Format src_format, Image::Format dst_format)
{
    ...
    switch (dst_format) {
        case Image::Format::eGray8Uint: {
            src_image_var = convert_from_color_to_gray<boost::gil::gray8_image_t>(src_color_image_var);
        } break;
        case Image::Format::eGray16Uint: {
            src_image_var = convert_from_color_to_gray<boost::gil::gray16_image_t>(src_color_image_var);
        } break;
        case Image::Format::eGray32Float: {
            src_image_var = convert_from_color_to_gray<boost::gil::gray32f_image_t>(src_color_image_var);
        } break;
    }
}
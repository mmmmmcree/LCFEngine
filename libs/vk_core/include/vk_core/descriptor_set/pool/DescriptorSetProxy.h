...
public:
    Self & setBuffer(uint32_t binding, const vkc::Buffer & buffer, vk::DeviceSize offset, vk::DeviceSize range) noexcept;
    Self & setBuffer(uint32_t binding, uint32_t array_index, const vkc::Buffer & buffer, vk::DeviceSize offset, vk::DeviceSize range) noexcept;

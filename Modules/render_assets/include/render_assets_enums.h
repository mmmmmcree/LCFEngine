...
namespace lcf {
    ...
    {
        eBaseColor = (to_integral(MaterialType::ePBR) << 16) | 0,
        eDiffuse = (to_integral(MaterialType::eLegacyShadingModels) << 16) | 0,
        eNormal = (to_integral(MaterialType::eShadingModels) << 16) | 1,
        eMetallicRoughness = (to_integral(MaterialType::ePBR_MetallicRoughness) << 16) | 2,
        eSpecularGlossiness = (to_integral(MaterialType::ePBR_SpecularGlossiness) << 16) | 2,
        eSpecular = (to_integral(MaterialType::eLegacyShadingModels) << 16) | 2,
        eEmissive = (to_integral(MaterialType::eShadingModels) << 16) | 3,
        eAmbientOcclusion = (to_integral(MaterialType::eShadingModels) << 16) | 4,
        eHeight = (to_integral(MaterialType::eShadingModels) << 16) | 5,
        eOpacity = (to_integral(MaterialType::eShadingModels) << 16) | 6,
